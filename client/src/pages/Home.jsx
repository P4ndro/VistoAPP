            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                <div className="text-center">
                    ...
                    <p className="text-gray-600">
                        Seamlessly connect your GitHub account and sync your repositories
                    </p>
                </div>
                <div className="text-center">
                    <div className="bg-gray-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                    ...
                    <p className="text-gray-600">
                        View detailed insights about your coding activity and contributions
                    </p>
                </div>
                <div className="text-center">
                    <div className="bg-gray-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                    ...
                    <p className="text-gray-600">
                        Design and customize your portfolio to showcase your work
                    </p>
                </div>
            </div>
